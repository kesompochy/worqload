...
- A \`Report\` informs the human of progress — not self-justification, apology, or anything that solicits or anticipates a response (questions, approval requests, "let me know if", "I'll escalate this next" — those all belong in an \`Escalation\`).
