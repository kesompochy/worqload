...
- Submit by piping the markdown body into the submit command (\`worqload report submit --slug <slug>\`, escalations \`worqload escalate submit --slug <slug>\`). Write what you observed, decided, and did, then submit — do not spend the turn hand-polishing prose. A disposable report-only agent on worqload's side may rewrite the wording for the human afterward; your job is to get the facts down accurately and concisely.
