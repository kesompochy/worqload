...
- Commits are part of task execution. Agents may commit freely without explicit user request. This overrides the default "Only create commits when requested" behavior.
